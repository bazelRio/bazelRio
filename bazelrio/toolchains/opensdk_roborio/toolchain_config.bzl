...
def _impl(ctx):
    ...
    return cc_common.create_cc_toolchain_config_info(
        ctx = ctx,
        toolchain_identifier = "opensdk_roborio_toolchain",
        ...
        builtin_sysroot = "external/__bazelrio_opensdk_roborio_toolchain_{}/roborio/arm-nilrt-linux-gnueabi/sysroot".format(
            ctx.attr.host_os,
        ),
        features = [
            feature(
