...
def setup_sparkmax_dependencies():
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-cpp_none_headers",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-driver_none_headers",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-cpp_none_windowsx86-64",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-cpp_none_windowsx86-64static",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-cpp_none_linuxx86-64",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-cpp_none_linuxx86-64static",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-cpp_none_linuxathena",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-cpp_none_linuxathenastatic",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-cpp_none_osxx86-64",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-cpp_none_osxx86-64static",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-driver_none_windowsx86-64",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-driver_none_windowsx86-64static",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-driver_none_linuxx86-64",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-driver_none_linuxx86-64static",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-driver_none_linuxathena",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-driver_none_linuxathenastatic",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-driver_none_osxx86-64",
    ...
    maybe(
        http_archive,
        "__bazelrio_com_revrobotics_frc_sparkmax-driver_none_osxx86-64static",
