...
def setup_ni_dependencies():
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_ni-libraries_chipobject_none_linuxathena",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_ni-libraries_visa_none_linuxathena",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_ni-libraries_runtime_none_linuxathena",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_ni-libraries_netcomm_none_linuxathena",
