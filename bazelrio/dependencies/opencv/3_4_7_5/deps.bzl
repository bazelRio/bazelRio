...
def setup_opencv_3_4_7_5_dependencies():
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_thirdparty_frc2021_opencv_opencv-cpp_linuxathena",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_thirdparty_frc2021_opencv_opencv-cpp_linuxathenastatic",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_thirdparty_frc2021_opencv_opencv-cpp_windowsx86-64",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_thirdparty_frc2021_opencv_opencv-cpp_linuxx86-64",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_thirdparty_frc2021_opencv_opencv-cpp_osxx86-64",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_thirdparty_frc2021_opencv_opencv-cpp_windowsx86-64static",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_thirdparty_frc2021_opencv_opencv-cpp_linuxx86-64static",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_thirdparty_frc2021_opencv_opencv-cpp_osxx86-64static",
    ...
    maybe(
        http_archive,
        "__bazelrio_edu_wpi_first_thirdparty_frc2021_opencv_opencv-cpp_headers",
